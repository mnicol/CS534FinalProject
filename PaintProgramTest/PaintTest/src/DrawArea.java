...
public class DrawArea extends JComponent
{
	...
	// Brush Size Options
	BrushSizeLUT brushLut = BrushSizeLUT.getInstance();
		...
		addMouseListener(new MouseAdapter()
		{
			...
			public void mouseReleased(MouseEvent e)
			{
				...
				if(g2 != null && selectionMode.equals("findObject"))
				{
					...
					// Fill in additional pixels for thicker lines
					// This will make the cursor a larger box
					/*for (int i = 0; i < offsetArray.length; i++)
					{
						g2.drawLine(oldX + offsetArray[i][0], 
								oldY + offsetArray[i][1], 
								currentX_drag + offsetArray[i][0],
								currentY_drag + offsetArray[i][1]);
					}*/
	...
	protected void paintComponent(Graphics g)
	{
		if (image == null)
		{
			...
			try
			{
				...
				drawingLayer = new BufferedImage(buffImg.getWidth(), buffImg.getHeight(), BufferedImage.TYPE_INT_ARGB);
	...
	{
		offsetArray = brushLut.getOffsetArray(size);
	}
